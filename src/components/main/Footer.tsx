...
const Footer = () => {
  ...
  return (
    <footer className={`${isDark ? 'bg-black' : 'bg-gray-900'} text-white py-12`}>
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className={`${isDark ? 'text-gray-500' : 'text-gray-400'} mb-6`}>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className={`${isDark ? 'text-gray-500 hover:text-[#3AAFF0]' : 'text-gray-400 hover:text-[#3AAFF0]'} transition-colors`}>
                  Features
                </a>
              </li>
              <li>
        ...
        <div className={`border-t ${isDark ? 'border-gray-700' : 'border-gray-800'} mt-12 pt-8 flex flex-col md:flex-row justify-between items-center`}>
          <p className={`${isDark ? 'text-gray-500' : 'text-gray-400'} text-sm mb-4 md:mb-0`}>
            &copy; {new Date().getFullYear()} Database Creator. All rights reserved.
          </p>
          <div className="flex space-x-6">
            <a href="#" className={`${isDark ? 'text-gray-500 hover:text-[#3AAFF0]' : 'text-gray-400 hover:text-[#3AAFF0]'} transition-colors text-sm`}>
              Privacy
            </a>
            <a href="#" className={`${isDark ? 'text-gray-500 hover:text-[#3AAFF0]' : 'text-gray-400 hover:text-[#3AAFF0]'} transition-colors text-sm`}>
              Terms
