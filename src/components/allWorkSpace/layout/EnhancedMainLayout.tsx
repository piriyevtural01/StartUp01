...
import EnhancedWorkspacePanel from '../panels/EnhancedWorkspacePanel';
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
      ...
      <div className="flex-1 flex relative">
        ...
        {/* Enhanced Left Panel - Advanced Tools */}
        <div className={`
        ...
        {/* Center Panel - Enhanced Workspace */}
        <div className="flex-1 lg:w-3/5">
          <EnhancedWorkspacePanel />
        </div>

        {/* Enhanced Right Panel - Portfolio & Chat */}
        <div className={`
